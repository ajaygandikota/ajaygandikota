...
SOC Architecture • DevSecOps Security • Threat Intelligence • Security
Automation

`<img src="https://readme-typing-svg.herokuapp.com?size=25&duration=4000&color=00FF9C&center=true&vCenter=true&width=700&lines=SOC+Architecture+Engineer;DevSecOps+Security+Automation;Threat+Detection+%26+Incident+Response;Cloud+Security+AWS+Azure+GCP;Security+Engineering+%7C+Python+Automation" />`{=html}
:::
...
![Top
Langs](https://github-readme-stats.vercel.app/api/top-langs/?username=YOUR_GITHUB_USERNAME&layout=compact&theme=tokyonight)
